...
[System.Serializable]
public class CorrectAnswersTrain
{
...
public class ConectorManagerTrain : MonoBehaviour {
    ...
    public CorrectAnswersTrain correctAnswers;
    ...
    public void Shuffle()
    {
        ...
        foreach (Transform item in SpwanActivators)
        {
            ...
            objectActivator.GetComponent<ActivatorsTrain>().id = count;

            objectReceptor.name = "Receptor " + count.ToString();
            objectReceptor.GetComponentInChildren<ReceptorsTrain>().id = count;
